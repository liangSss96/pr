/*
 * @Author: windzu
 * @Date: 2022-03-01 14:32:43
 * @LastEditTime: 2022-04-16 21:14:20
 * @LastEditors: windzu
 * @Description:
 * @FilePath: /windzu_ws/src/tld/tld/tld_detector/src/calibrator.cpp
...
Int8EntropyCalibrator2::Int8EntropyCalibrator2(int batchsize, int input_w, int input_h, const char* img_dir,
  ...
  read_file_from_dir(img_dir, &img_files_);
}

Int8EntropyCalibrator2::~Int8EntropyCalibrator2() { CUDA_CHECK(cudaFree(device_input_)); }

int Int8EntropyCalibrator2::getBatchSize() const TRT_NOEXCEPT { return batchsize_; }
...
bool Int8EntropyCalibrator2::getBatch(void* bindings[], const char* names[], int nbBindings) TRT_NOEXCEPT {
  ...
  for (int i = img_idx_; i < img_idx_ + batchsize_; i++) {
    ...
    cv::Mat pr_img = resize_img(temp, input_w_, input_h_);
